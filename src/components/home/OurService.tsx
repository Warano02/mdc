...
function OurService() {
    return (
        <section className="my-12 container">
            ...
            <div className="flex items-center justify-center overflow-scroll no-scrollbar gap-4 relative">
                <div className="flex flex-col items-center rounded shadow h-105 w-66.5 space-y-12 shrink-0 bg-[#F7F7F7] p-4">
                ...
                <div className="flex flex-col items-center rounded shadow h-105 space-y-12 w-66.5 shrink-0 bg-[#F7F7F7] p-4">
                    <div className="size-20  relative">
                ...
                <div className="flex flex-col items-center rounded shadow h-105 space-y-6 w-66.5 shrink-0 bg-[#F7F7F7] p-4">
                    <div className="size-20  relative">
