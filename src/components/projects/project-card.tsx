...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="overflow-hidden relative rounded-lg bg-muted/30 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.1),0px_2px_6px_0px_rgba(0,0,0,0.08)] h-27.5">
      <div className="absolute bottom-0 left-0 right-0 h-2.5 overflow-hidden rounded-b-lg">
        <div
      ...
      <div className="absolute left-3 top-3 right-3 flex flex-col gap-2.5 h-full pb-3.5">
        <div className="flex flex-col gap-1.5 min-h-10.5">
          <div className="flex items-center gap-2 h-5">
            <h3 className="flex-1 text-sm font-medium text-foreground truncate min-w-0 leading-4.5 whitespace-nowrap">
              {project.title}
            </h3>
            <Button
              variant="ghost"
          ...
          <p className="text-xs text-muted-foreground leading-4 whitespace-pre-wrap">
        ...
        <div className="flex items-center justify-between h-5.5">
          {showPriority && (
            ...
            >
              ...
              <span
                className={cn(
                  "text-sm font-medium capitalize leading-4.5",
                  priorityColor.text
                )}
              >
                {project.priority}
