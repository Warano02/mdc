...
export const metadata = {
    title: "Meet the Experts: Giovanni Mariella | MDC Canada",
    description: "Meet Giovanni Mariella, discover her expertise, insights, and role in helping clients succeed in Canada."
}
const stats = [
            ...
            <section className="w-full h-[36em] bg-cover bg-center bg-no-repeat relative"
                ...
                <div className="relative z-10 h-full flex flex-col justify-center">
                    <div className="ml-12 flex flex-col justify-center w-[50em] max-w-full text-white max-md:ml-0 max-md:items-center max-md:w-full max-md:px-6">
                        <h1 className="text-5xl font-serif mb-6">Meet the Experts: Giovanni Mariella</h1>
                        <p className="font-semibold leading-relaxed mb-8 max-w-sm">
                            Meet Giovanni Mariella, discover her expertise, insights, and role in helping clients succeed in Canada.
                        </p>
                        <SignupDialog>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">RCIC Identification <span className="text-primary font-semibold">#R705710</span></p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-bold text-sm text-gray-800">Giovanni Mariella</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex gap-8 px-8 py-10 w-full max-w-5xl mx-auto max-md:flex-col">
                <article className="flex-1 min-w-0 flex flex-col gap-4">
                    ...
                    <div className="w-full mt-4">
                        <Image
                            src="/img/Ask_ Giovanni_Mariella (1)-1673615495265.jpg"
